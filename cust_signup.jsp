...
<div class="container">
<div class="row">
<form action="CustomerSignup.jsp" style="border:1px solid #ccc" method="post" onsubmit="return validate()">
        <div class="mainContainer">
          <h1>Sign Up</h1>
          <p style="text-align: center;">Please fill in this form to Add a Customer.</p>
          <hr>
          ...
          <input type="tel" placeholder="Mob No" name="mobile" id="mobile" required>
          ...
          <label>GENDER:</label>
                ...
                <input type="radio" name="GENDER" value="Othes" id="gender">
