...
.styled-table thread tr{background-color:#009879; color:#ffffff; text-align:left;}
...
.styled-table tbody tr.active-ro{font-weight:bold; color:#009879;}
...
<div id="navigation">
    ...
    <li><a href="griv_signup.html">Add Employee</a></li>
    <li><a href="Emp.jsp">Employee List</a>
...
<div class="row">
<%
List<EmpInfo> list = EmpDao.getAllEmp();
out.println("<table border='1'  width='100%' class='styled-table'>");
out.println("<thead><tr><th>NAME</th><th>EMAIL</th><th>MOBILE NUMBER</th><th>DOB</th><th>ADDRESS</th><th>GENDER</th><th>EMP_TYPE</th></tr></thead>");
for(EmpInfo u:list){
	out.println("<tbody><tr><td>"+u.getName()+"</td><td>"+u.getEmail()+"</td><td>"+u.getMobile()+"</td><td>"+u.getDob()+"</td><td>"+u.getAddress()+"</td><td>"+u.getGender()+"</td><td>"+u.getEmp_type()+"</td></tr></tbody>");
}
%>
</div>
</div>
